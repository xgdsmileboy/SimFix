...
public class CodeBlockMatcher {
	...
	public static List<Delta> match(CodeBlock src, CodeBlock tar, Map<String, Type> allUsableVariables){
		List<Delta> modifications = new ArrayList<>();
	...
	private static List<Delta> compareStructure(Structure src, Structure tar,  Map<String, Type> allUsableVariables){
		List<Delta> modifications = new ArrayList<>();
